...
pub const STACK_GRAPHS_BUILTINS_PATH: &str = "src/builtins.scala";
/// The stack graphs builtins source for this language.
pub const STACK_GRAPHS_BUILTINS_SOURCE: &str = include_str!("../src/builtins.scala");
...
pub fn try_language_configuration(
    ...
    LanguageConfiguration::from_sources(
        ...
        Some(String::from("source.scala")),
        None,
        vec![String::from("scala")],
